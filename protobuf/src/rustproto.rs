...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    le.protobuf.FileOptionsR\x11serdeDeriveCfgAll:N\n\x13disable_reflect_all\
    \x18\x88\x85\x01\x20\x01(\x08\x12\x1c.google.protobuf.FileOptionsR\x11di\
    sableReflectAll:D\n\x0cexpose_oneof\x18\xe9\x84\x01\x20\x01(\x08\x12\x1f\
    .google.protobuf.MessageOptionsR\x0bexposeOneof:F\n\rexpose_fields\x18\
    \xeb\x84\x01\x20\x01(\x08\x12\x1f.google.protobuf.MessageOptionsR\x0cexp\
    oseFields:P\n\x12generate_accessors\x18\xec\x84\x01\x20\x01(\x08\x12\x1f\
    .google.protobuf.MessageOptionsR\x11generateAccessors:^\n\x1acarllerche_\
    bytes_for_bytes\x18\xf3\x84\x01\x20\x01(\x08\x12\x1f.google.protobuf.Mes\
    sageOptionsR\x17carllercheBytesForBytes:`\n\x1bcarllerche_bytes_for_stri\
    ng\x18\xf4\x84\x01\x20\x01(\x08\x12\x1f.google.protobuf.MessageOptionsR\
    ...
    ptionsR\x0eserdeDeriveCfg:J\n\x0fdisable_reflect\x18\x88\x85\x01\x20\x01\
    (\x08\x12\x1f.google.protobuf.MessageOptionsR\x0edisableReflect:O\n\x13e\
    xpose_fields_field\x18\xeb\x84\x01\x20\x01(\x08\x12\x1d.google.protobuf.\
    FieldOptionsR\x11exposeFieldsField:Y\n\x18generate_accessors_field\x18\
    \xec\x84\x01\x20\x01(\x08\x12\x1d.google.protobuf.FieldOptionsR\x16gener\
    ...
    rStringFieldJ\xb0\x14\n\x06\x12\x04\0\08\x01\n\x08\n\x01\x0c\x12\x03\0\0\
    \x12\n\t\n\x02\x03\0\x12\x03\x02\x07)\nh\n\x01\x02\x12\x03\x07\x08\x112^\
    \x20see\x20https://github.com/gogo/protobuf/blob/master/gogoproto/gogo.p\
    roto\n\x20for\x20the\x20original\x20idea\n\n\t\n\x01\x07\x12\x04\t\0\x1a\
    \x01\n7\n\x02\x07\0\x12\x03\x0b\x04+\x1a,\x20When\x20true,\x20oneof\x20f\
    ield\x20is\x20generated\x20public\n\n\n\n\x03\x07\0\x02\x12\x03\t\x07\"\
    ...
    \n\x02\x07\x07\x12\x03\x19\x082\x1a\x1c\x20When\x20true,\x20disable\x20r\
    eflect\n\n\n\n\x03\x07\x07\x02\x12\x03\t\x07\"\n\n\n\x03\x07\x07\x04\x12\
    \x03\x19\x08\x10\n\n\n\x03\x07\x07\x05\x12\x03\x19\x11\x15\n\n\n\x03\x07\
    \x07\x01\x12\x03\x19\x16)\n\n\n\x03\x07\x07\x03\x12\x03\x19,1\n\t\n\x01\
    \x07\x12\x04\x1c\0-\x01\n7\n\x02\x07\x08\x12\x03\x1e\x04'\x1a,\x20When\
    \x20true,\x20oneof\x20field\x20is\x20generated\x20public\n\n\n\n\x03\x07\
    \x08\x02\x12\x03\x1c\x07%\n\n\n\x03\x07\x08\x04\x12\x03\x1e\x04\x0c\n\n\
    ...
    \x07\x0c\x03\x12\x03&05\nJ\n\x02\x07\r\x12\x03(\x04'\x1a?\x20Use\x20`ser\
    de_derive`\x20to\x20implement\x20`Serialize`\x20and\x20`Deserialize`\n\n\
    \n\n\x03\x07\r\x02\x12\x03\x1c\x07%\n\n\n\x03\x07\r\x04\x12\x03(\x04\x0c\
    \n\n\n\x03\x07\r\x05\x12\x03(\r\x11\n\n\n\x03\x07\r\x01\x12\x03(\x12\x1e\
    \n\n\n\x03\x07\r\x03\x12\x03(!&\n3\n\x02\x07\x0e\x12\x03*\x04-\x1a(\x20G\
    uard\x20serde\x20annotations\x20with\x20cfg\x20attr.\n\n\n\n\x03\x07\x0e\
    \x02\x12\x03\x1c\x07%\n\n\n\x03\x07\x0e\x04\x12\x03*\x04\x0c\n\n\n\x03\
    \x07\x0e\x05\x12\x03*\r\x13\n\n\n\x03\x07\x0e\x01\x12\x03*\x14$\n\n\n\
    \x03\x07\x0e\x03\x12\x03*',\n'\n\x02\x07\x0f\x12\x03,\x08.\x1a\x1c\x20Wh\
    en\x20true,\x20disable\x20reflect\n\n\n\n\x03\x07\x0f\x02\x12\x03\x1c\
    \x07%\n\n\n\x03\x07\x0f\x04\x12\x03,\x08\x10\n\n\n\x03\x07\x0f\x05\x12\
    \x03,\x11\x15\n\n\n\x03\x07\x0f\x01\x12\x03,\x16%\n\n\n\x03\x07\x0f\x03\
    \x12\x03,(-\n\t\n\x01\x07\x12\x04/\08\x01\nI\n\x02\x07\x10\x12\x031\x04.\
    \x1a>\x20When\x20true\x20all\x20fields\x20are\x20public,\x20and\x20not\
    \x20accessors\x20generated\n\n\n\n\x03\x07\x10\x02\x12\x03/\x07#\n\n\n\
    \x03\x07\x10\x04\x12\x031\x04\x0c\n\n\n\x03\x07\x10\x05\x12\x031\r\x11\n\
    \n\n\x03\x07\x10\x01\x12\x031\x12%\n\n\n\x03\x07\x10\x03\x12\x031(-\nP\n\
    \x02\x07\x11\x12\x033\x043\x1aE\x20When\x20false,\x20`get_`,\x20`set_`,\
    \x20`mut_`\x20etc.\x20accessors\x20are\x20not\x20generated\n\n\n\n\x03\
    \x07\x11\x02\x12\x03/\x07#\n\n\n\x03\x07\x11\x04\x12\x033\x04\x0c\n\n\n\
    \x03\x07\x11\x05\x12\x033\r\x11\n\n\n\x03\x07\x11\x01\x12\x033\x12*\n\n\
    \n\x03\x07\x11\x03\x12\x033-2\n2\n\x02\x07\x12\x12\x035\x04;\x1a'\x20Use\
    \x20`bytes::Bytes`\x20for\x20`bytes`\x20fields\n\n\n\n\x03\x07\x12\x02\
    \x12\x03/\x07#\n\n\n\x03\x07\x12\x04\x12\x035\x04\x0c\n\n\n\x03\x07\x12\
    \x05\x12\x035\r\x11\n\n\n\x03\x07\x12\x01\x12\x035\x122\n\n\n\x03\x07\
    \x12\x03\x12\x0355:\n3\n\x02\x07\x13\x12\x037\x04<\x1a(\x20Use\x20`bytes\
    ::Bytes`\x20for\x20`string`\x20fields\n\n\n\n\x03\x07\x13\x02\x12\x03/\
    \x07#\n\n\n\x03\x07\x13\x04\x12\x037\x04\x0c\n\n\n\x03\x07\x13\x05\x12\
    \x037\r\x11\n\n\n\x03\x07\x13\x01\x12\x037\x123\n\n\n\x03\x07\x13\x03\
    \x12\x0376;\
";
